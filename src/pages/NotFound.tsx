...
const NotFound = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0a1520] via-[#1a3b4d] to-[#161718] text-white relative overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col items-center">
      <h1 className="text-8xl font-extrabold tracking-tight bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent drop-shadow-lg animate-fade-in">
        404
      </h1>
      ...
      <a
        href="/"
        className="px-8 py-3 rounded-full bg-gradient-to-r from-green-400 to-blue-400 text-white font-bold shadow-lg hover:scale-105 transition-transform duration-200 animate-fade-in-slower"
      >
        Return Home
      </a>
    </div>
