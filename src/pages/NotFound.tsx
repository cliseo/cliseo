...
const ORBIT_SHAPES = [
  { color: 'from-green-400 to-blue-400', size: 'w-16 h-16', delay: '0s', radius: '22vw', blur: 'blur', tilt: 'rotateX(0deg)' },
  { color: 'from-purple-500 to-blue-400', size: 'w-20 h-20', delay: '0.3s', radius: '28vw', blur: 'blur-sm', tilt: 'rotateX(18deg)' },
  { color: 'from-pink-400 to-purple-500', size: 'w-12 h-12', delay: '0.6s', radius: '34vw', blur: '', tilt: 'rotateY(12deg)' },
  { color: 'from-yellow-400 to-green-400', size: 'w-14 h-14', delay: '0.9s', radius: '26vw', blur: 'blur-sm', tilt: 'rotateX(10deg) rotateY(10deg)' },
  { color: 'from-cyan-400 to-blue-400', size: 'w-10 h-10', delay: '1.2s', radius: '30vw', blur: '', tilt: 'rotateY(-14deg)' },
];
